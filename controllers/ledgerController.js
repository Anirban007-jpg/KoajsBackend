...
exports.createLedger = async (ctx) => {
    ...
    try {
        ...
        if (!presentledger) {
            ...
            const newledger = new Ledger({ Ledger_Name,Opening_Balance,Balance : {Previous_Balance: Opening_Balance, Previous_Balance_Date: Date.now()},type_of_ledger,balance_type,BS_Type_Item,PL_Type_Item,Current_Balance: Current_Balance });
